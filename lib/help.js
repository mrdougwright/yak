...
export function showHelp() {
  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { cmd: "http or www", desc: "Chat will detect given URLs and crawl them" },
      ],
    },
  ];
  ...
  const footer = [
    chalk.dim("Examples:"),
    chalk.cyan("  yak new python-help") + chalk.dim("   Create chat for Python questions"),
    chalk.cyan("  yak model gemma2:2b") + chalk.dim("   Switch to faster model"),
    chalk.cyan("  yak start") + chalk.dim("             Begin chatting"),
    "",
    chalk.dim("For more info: ") + chalk.cyan("https://github.com/mrdougwright/yak"),
  ];
